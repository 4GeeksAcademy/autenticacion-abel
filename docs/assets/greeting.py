...
if environment == "back":
    print(
        f"""
    Hello! This terminal will represent your python backend!
...
if environment == "both":
    ...
    1. Start by running your python backend using the command:
       {blue("$ pipenv run start")}
    2. Open a new terminal to run your front-end with the following command:
       {blue("$ npm run start")}

    Note: Please keep in mind you will always need two terminals,
